...
pub fn execute(
    ...
    match msg {
        ...
        SendMessageCosmos { destination_chain, destination_address, message } => todo!(),
        ReceiveMessageCosmos { sender, message } => todo!(),
        ReceiveMessageEvm { source_chain, source_address, payload } => todo!(),
    }
}
